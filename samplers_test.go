	...
	return []CSVTestCase{
		{
			...
			Row: strings.NewReader(fmt.Sprintf("a.b.c.max\t{foo:bar,baz:quz}\tgauge\tglobalstats\ttestbox-c3eac9\tfood\t0\t10.10.2016 01:04:18\t100\t%s\n", partition)),
		},
		{
			...
			Row: strings.NewReader(fmt.Sprintf("a.b.c.max\t{foo:bar,baz:quz}\trate\tlocalhost\ttestbox-c3eac9\t\t10\t10.10.2016 01:04:18\t100\t%s\n", partition)),
		},
		{
			...
			Row: strings.NewReader(fmt.Sprintf("a.b.c.max\t\"{foo:b\tar,baz:quz}\"\trate\tlocalhost\ttestbox-c3eac9\teniac\t10\t10.10.2016 01:04:18\t100\t%s\n", partition)),
		},
	}
}
