...
//go:generate protoc --go_opt=paths=source_relative --go_out=. tdigest/tdigest.proto
//go:generate protoc --go_opt=paths=source_relative --go_out=. samplers/metricpb/metric.proto
