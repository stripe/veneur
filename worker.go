...
func NewWorker(id int, isLocal bool, countUniqueTimeseries bool, cl *trace.Client, logger *logrus.Logger, stats scopedstatsd.Client, defaultMetricScope samplers.MetricScope) *Worker {
	return &Worker{
		id:                    id,
		isLocal:               isLocal,
