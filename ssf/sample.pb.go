...
func (*SSFSpanCollection) Descriptor() ([]byte, []int) { return fileDescriptorSample, []int{2} }
...
func (m *SSFSpanCollection) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SSFSpanCollection) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SSFSpanCollection) Size() (n int) {
	var l int
	_ = l
	if len(m.Spans) > 0 {
...
func (m *SSFSpanCollection) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SSFSpanCollection: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SSFSpanCollection: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Spans = append(m.Spans, &SSFSpan{})
...
var fileDescriptorSample = []byte{
	...
	,
}
