...
type Config struct {
	...
	Features                     struct {
		EnableMetricComputationRouting bool `yaml:"enable_metric_computation_routing"`
	...
	MetricComputationRouting                  []ComputationRoutingConfig `yaml:"metric_computation_routing"`
